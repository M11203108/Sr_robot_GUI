...
class MapWindow(QMainWindow):
    def __init__(self, yaml_files, pgm_files):
        ...
        file_buttons_layout1.addWidget(self.save_file_button)
        file_buttons_layout1.addWidget(self.delete_file_button)

        # 新增水平佈局，用於放置載入檔案和取消檔案按鈕
        file_buttons_layout2 = QHBoxLayout()
        file_buttons_layout2.addWidget(self.load_file_button)
        file_buttons_layout2.addWidget(self.cancel_file_button)
