...
class MapWindow(QMainWindow):
    def __init__(self, yaml_files, pgm_files):
        ...
        self.load_file_button.setFixedSize(120, 50)
    ...
    def load_file(self):
        ...
        try:
            ...
            # 更新地圖上的點位與方向
            self.label.update_points_and_directions(self.recorded_points)
            print("地圖已成功更新")
...
# """
    ...
    def paintEvent(self, event):
        ...
        for j, (start_point, end_point) in enumerate(self.directions):
            ...
            painter.drawText(start_point.x() + 10, start_point.y() + 10, str(j + 1))
