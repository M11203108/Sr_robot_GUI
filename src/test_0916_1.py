...
class MapWindow(QMainWindow):
    ...
    def start_process(self):
        print("啟動按鈕被點擊")
        subprocess.Popen([
            "xterm", "-e", "bash -c 'cd ~/wheeltec_ros2 && source install/setup.bash && /bin/python3.10 /home/sr/wheeltec_ros2/src/wheeltec_robot_nav2/launch/waypoint_testgui.py; exec bash'"
        ])
