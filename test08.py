...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.rviz2_button.clicked.connect(self.launch_rviz2)
    ...
    def start_process(self):
        ...
        # 開啟 xterm 並執行指令
        subprocess.Popen([
            "xterm", "-e", "bash -c 'cd ~/wheeltec_ros2/ && source install/setup.bash && ros2 launch wheeltec_nav2 wheeltec_nav2.launch.py'"
        ])
    ...
    def stop_process(self):
        print("STOP 按鈕被點擊")
        # 終止指令
        subprocess.Popen(["pkill", "-f", "ros2 launch wheeltec_nav2 wheeltec_nav2.launch.py"])
    ...
    def launch_rviz2(self):
        print("RViz2 按鈕被點擊")
        subprocess.Popen([
        "xterm", "-e", "bash -i -c 'source ~/wheeltec_ros2/install/setup.bash && ros2 run rviz2 rviz2'"
        ])
