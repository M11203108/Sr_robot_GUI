...
class MapLabel(QLabel):
    ...
    def paintEvent(self, event):
        ...
        # 繪製原點
        origin_px_x = (self.origin[0] - self.origin[0]) / self.resolution * self.scale_factor
        origin_px_y = self.image_height * self.scale_factor - ((self.origin[1] - self.origin[1]) / self.resolution * self.scale_factor)
