...
import os
import subprocess
from PyQt5.QtWidgets import QApplication, QLabel, QMainWindow, QVBoxLayout, QPushButton, QWidget, QLineEdit, QMessageBox, QInputDialog, QSlider
...
class MapBuilderWindow(QMainWindow):
    def __init__(self):
        ...
        self.map_label.setFixedSize(400, 400)  # 設定固定大小
        ...
        self.rotation_slider.valueChanged.connect(self.rotate_map)
    ...
    def rotate_map(self):
        ...
        if self.current_map_path:
            ...
            transform = QTransform().rotate(self.rotation_slider.value())
            rotated_pixmap = pixmap.transformed(transform, Qt.SmoothTransformation)
            self.map_label.setPixmap(rotated_pixmap.scaled(self.map_label.size(), Qt.KeepAspectRatio))
